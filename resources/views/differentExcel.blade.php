...
<body>
    <div class="container py-5">
        ...
        <div class="animate__animated animate__fadeInUp animate__faster form-container">
            <h4 class="form-title text-center animate__animated animate__fadeIn">Different Excel to Database Upload</h4>
            ...
            <form action="{{ route('differentExcel.store') }}" method="post" enctype="multipart/form-data"
                ...
                {{-- <div class="mb-4">
                    <label for="version_name" class="form-label fw-medium">Version Name</label>
                    <input type="text" name="version_name" id="version_name" class="form-control shadow-sm"
                        placeholder="Enter your version name" value="{{ old('version_name') }}">
                    @error('version_name')
                ...
                <div class="mb-4">
                    ...
                    <div class="file-upload-wrapper">
                        <label class="file-upload-label @error('excel_file') border-danger @enderror">
                            <i class="fas fa-file-import"></i>
                            <span id="file-name">Choose or drag & drop your Excel file</span>
                            <input type="file" name="excel_file" id="excel" class="file-upload-input"
                                accept=".xlsx,.xls" required>
                        </label>
                    </div>
                    <div class="mt-2">
                        <a href="{{ asset('sample-excel/sample-Gdata-forDifferent.xlsx') }}" class="sample-link"
                            download>
            ...
            $('#excel').on('change', function() {
                ...
                if (fileName) {
                    ...
                    if (!allowedExtensions.exec(fileName)) {
                        $('#file-name').html(
                            '<span class="text-danger">Please upload a valid Excel file (.xlsx or .xls)</span>'
                        );
                        $(this).val('');
